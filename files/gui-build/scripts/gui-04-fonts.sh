#!/usr/bin/env bash
set -euo pipefail
# Google Sans Flex: end-4's default UI font. Not packaged for Arch/AUR, so take
# the Fedora COPR RPM end-4 ships and extract the font files from it (pinned by
# sha256). bsdtar (libarchive) can read RPMs.
