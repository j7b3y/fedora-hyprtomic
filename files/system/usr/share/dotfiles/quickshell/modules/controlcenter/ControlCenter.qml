...
Scope {
    ...
    Process {
        id: themeSaveProc
        command: ["sh", "-c", "echo '" + Root.Theme.currentTheme + "' > ~/.config/quickshell/current-theme"]
    }

    Process {
        id: themeApplyProc
        command: ["sh", "-c", "~/.config/quickshell/scripts/apply-theme.sh " + Root.Theme.currentTheme]
    }
