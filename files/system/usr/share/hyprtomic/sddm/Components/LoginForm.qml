...
//
// HyprTomic override of the upstream Components/LoginForm.qml: the same layout
// plus the FingerprintStatus line that shows the pam_fprintd prompts.  Refresh
// this file when the upstream theme changes the form layout.
